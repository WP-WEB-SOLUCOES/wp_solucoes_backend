...
// === CORREÇÃO AQUI ===
// Lê do sessionStorage, e não mais do localStorage.
...
document.addEventListener('DOMContentLoaded', () => {
 ...
    // Verifica o sessionStorage, e não mais o 'token'
...
async function loadPage(pageName) {
 ...
    try {
        // === CORREÇÃO AQUI ===
        // Usa credentials: 'include' e não envia 'Authorization' header
...
function initializeSocket() {
 ...
        // === CORREÇÃO AQUI ===
        // Evento 'admin_auth' removido. A autenticação é automática.
    });
