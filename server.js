...
        console.log(`Atendente ${username} (Role: ${role}) se juntou ao chat.`);
        broadcastAttendantList();

        // Busca sessões ativas e envia para o admin que acabou de entrar
        (async () => {
            try {
...
        // *** CORREÇÃO: Linha 'if (socket.user) return;' removida ***
        if (!sessionId) return;
...
        // *** CORREÇÃO: Verificação 'socket.user' removida ***
